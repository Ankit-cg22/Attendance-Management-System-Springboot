...
public interface CourseService {
    ...
    List<Student> fetchEnrolledStudents(Integer courseId) throws ResourceNotFoundException;

    List<Student> fetchNotEnrolledStudents(Integer courseId) throws ResourceNotFoundException;
}
